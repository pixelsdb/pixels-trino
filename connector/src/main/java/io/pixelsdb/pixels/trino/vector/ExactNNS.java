...
public class ExactNNS {
    ...
    int k;
    VecDistReverseComparator vecDistDescComparator;
    int colId;
    ...
    public ExactNNS(double[] inputVec, String[] listOfFiles, int k, VectorDistFunc vectorDistFunc, int colId)
    {
        ...
        this.k = k;
        this.vecDistDescComparator = new VecDistReverseComparator(inputVec, vectorDistFunc);
        this.colId = colId;
    }
     ...
     */
    class VecDistReverseComparator implements Comparator<double[]>
    {
        double[] inputVec;
        VectorDistFunc vectorDistFunc;

        public VecDistReverseComparator(double[] inputVec, VectorDistFunc vectorDistFunc) {
        ...
        public int compare(double[] v1, double[] v2) {
            return (int)(vectorDistFunc.getDist(v1, inputVec) - vectorDistFunc.getDist(v2, inputVec));
        }
    }
