...
public class CheckExperimentData {
    public static void main(String[] args)
    {
        readWordEmbeddings("s3://tiannan-test/experiments/embd_1m/v-0-ordered/1.pxl");
    }

    public static void readWordEmbeddings(String currentPath) {
